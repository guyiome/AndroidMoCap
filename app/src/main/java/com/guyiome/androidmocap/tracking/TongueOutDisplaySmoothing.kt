...
/**
 * Lissage d'affichage LOCAL du signal `tongueOut` (panneau de test, jamais envoyé au réseau -- voir
 * `MainViewModel.handleTrackingResult`) : maintient l'affichage à "TONGUE_OUT" pendant [holdMs] après
 * la dernière classification positive, plutôt que de retomber à 0 dès la frame suivante. Motivé par
