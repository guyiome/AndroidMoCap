...
dependencies {
    ...
    // de l'API (préféré à org.json : reste testable en JVM pur, voir docs/AndroidMoCap_unit_tests.md).
    ...
    // Tests unitaires (JVM pur -- pas de dépendance Android, voir docs/AndroidMoCap_unit_tests.md)
